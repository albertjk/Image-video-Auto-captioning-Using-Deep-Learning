...
# This script downloads a specified number of training images
# of the Google Conceptual Captions dataset, gets their captions, 
# and produces a text file of image ID to caption mappings.
# The 'Train_GCC-training.tsv' file must be in the current directory.
import requests
...
def download_images_and_get_captions(target):
	"""
	Downloads the images of the training set using the links from the 
	training TSV file. Images that are not downloaded successfully are removed.
	...
	# If the 'train_images' directory does not exist, create it.
	...
	training_file = 'Train_GCC-training.tsv'	
	with open(training_file, encoding='utf-8') as f:
		lines = f.readlines()		

		# Continuously download images until there are as many 
		# in the 'train_images' folder as the target value.
...
if __name__ == '__main__':  
	...
	# Only the first 300,000 images and captions are needed.
	limit = 300000
