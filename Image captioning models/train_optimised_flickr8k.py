...
# This script is used for training the optimised model on the Flickr8K dataset.
...
def build_model(vocab_size, max_len, optimizer):
	"""
	Creates the optimised image captioning model best suited for the Flickr8K dataset.
...
if __name__ == '__main__':   
	...
	extracted_features_dir = "extracted_features_Flickr8k_Xception"
	...
	# Batch normalization is not applied as it did not enhance performance during experiments on Flickr8K.
	lr = 0.01604956256058524
	...
	file_path = 'trained_models/Optimised_Flickr8K.h5'

	# Name of the model to see on TensorBoard.
	model_name = "Optimised_Flickr8K"
	...
	tf.keras.utils.plot_model(model, to_file="trained_models/optimised_flickr8k_model.png", show_shapes=True)
