...
# This script is used for training the optimised model on the MSCOCO dataset.
...
def build_model(vocab_size, max_len, optimizer):
	"""
	Creates the optimised image captioning model best suited for the MSCOCO dataset.
...
if __name__ == '__main__':   
	...
	# Batch normalization is part of the model as it enhanced performance during experiments on MSCOCO. 
	lr = 0.0145	
	...
	file_path = 'trained_models/Optimised_MSCOCO.h5'

	# Name of the model to see on TensorBoard.
	model_name = "Optimised_MSCOCO"
	...
	tf.keras.utils.plot_model(model, to_file="trained_models/optimised_mscoco_model.png", show_shapes=True)
